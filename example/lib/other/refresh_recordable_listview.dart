...
class RefreshReorderableListView extends StatefulWidget {
  ...
  @override
  State<RefreshReorderableListView> createState() => _ReorderableListViewState();
}
...
class _ReorderableListContent extends StatefulWidget {
  ...
  final void Function()? onOffsetChange;
...
class _ReorderableListContentState extends State<_ReorderableListContent>
  ...
  Widget _wrap(Widget toWrap, int index, BoxConstraints constraints) {
    ...
    final GlobalObjectKey keyIndexGlobalKey = GlobalObjectKey(toWrap.key as Object);
    ...
    return LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints) {
      ...
      return SmartRefresher(
        ...
        child: ListView(
          ...
          reverse: widget.reverse,
          children: [_buildContainerForScrollDirection(children: wrappedChildren)],
        ),
      );
    });
  }
