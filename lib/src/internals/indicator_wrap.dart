...
abstract class LoadIndicator extends StatefulWidget {
  ...
  const LoadIndicator(
      {Key? key, this.onClick, this.loadStyle: LoadStyle.ShowAlways, this.height: 60.0})
      : super(key: key);
}
  ...
  void _handleModeChange() {
    ...
    if (mode == RefreshStatus.completed || mode == RefreshStatus.failed) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        _position!
            .animateTo(0.0, duration: const Duration(milliseconds: 500), curve: Curves.linear)
            .whenComplete(() {
          mode = RefreshStatus.twoLeveling;
        });
  ...
  Widget build(BuildContext context) {
    return SliverRefresh(
        ...
        child: RotatedBox(
          ...
          quarterTurns:
              needReverseAll() && Scrollable.of(context)!.axisDirection == AxisDirection.up
                  ? 10
                  : 0,
        ),
        floating: floating,
